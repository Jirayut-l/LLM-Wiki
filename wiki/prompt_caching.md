...
## Summary
**Prompt Caching** เป็นระบบที่ช่วยประหยัดค่าใช้จ่ายการใช้งาน [[token_optimization|Token]] เมื่อมีการส่ง Context หรือเนื้อหาเดิมซ้ำๆ ให้กับโมเดลภาษาอย่าง Claude โดย Token ที่ถูกดึงมาจาก Cache จะมีราคาถูกลงมาก ทำให้ผู้ใช้สามารถประหยัดโควตารวมถึงลดระยะเวลาในการประมวลผลลงได้อย่างมีนัยสำคัญ
