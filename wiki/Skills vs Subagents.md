...
## Summary
ทักษะ (Skills) และตัวแทนย่อย (Subagents) ใน Claude Code นั้นมีความคล้ายคลึงกันที่แก่นแท้ โดยเป็นการสร้างกฎการทำงานหรือ Prompt ที่เฉพาะเจาะจง แต่มีความแตกต่างหลักคือเรื่องของ Context Window, การทำงานคู่ขนาน, และการกำหนดโมเดล 
